...
const zh: Dict = {
	...
	"how.title": "我们怎么统计",
	"how.lead1":
		"只有一条规则「克隆大军」会把条目判定为假。其余四条只提供参考。Valve 自己的 {official} 台服务器不计入。",
	"how.lead2a": "有人走得更远。",
	"how.lead2b":
		"基于历史数据做分析，用来发现虚假在线人数的规律。我们只用一份公开列表。想改进判定逻辑？在 GitHub 上开 issue。",
	...
	"fix.title": "致 Valve：请修复跳转",
	"fix.p1": "整个镜像体系都建立在一个漏洞之上：服务器可以把正在加入的玩家跳转到无关的 IP",
	"fix.p2": "没有它，镜像就毫无意义，社区也能重新发展起来",
	"fix.tagline": "去掉跳转，90% 的问题就解决了",
